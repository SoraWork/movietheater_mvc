...
public class UserController {
    ...
    @AuthenticationPrincipal CustomUserDetails userDetails) {
        ...
        if (member.getAccount().getDateOfBirth() == null) {
            bindingResult.rejectValue("account.dateOfBirth", "account.dateOfBirth.empty", "DateOfBirth không được để trống");
        }
        ...
        if (member.getAccount().getPhoneNumber() == null || member.getAccount().getPhoneNumber().trim().isEmpty()) {
            bindingResult.rejectValue("account.phoneNumber", "account.phoneNumber.empty", "PhoneNumber không được để trống");
        }
